export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Crewup",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Crewup. ¿Quieres instalarla y reiniciar?",
