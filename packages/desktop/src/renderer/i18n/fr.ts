export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Crewup",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Crewup a été téléchargée. Voulez-vous l'installer et redémarrer ?",
