export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Crewup",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Crewup.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Crewup Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Crewup.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Crewup.",
  ...
  "dialog.server.description": "Switch which Crewup server this app connects to.",
  ...
  "toast.update.description": "A new version of Crewup ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Crewup team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Crewup does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Crewup includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Crewup server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Crewup",
  ...
  "settings.general.row.appearance.description": "Customise how Crewup looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Crewup follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Crewup is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Crewup launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Crewup.",
