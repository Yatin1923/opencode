export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Crewup",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Crewup er blevet downloadet. Vil du installere den og genstarte?",
