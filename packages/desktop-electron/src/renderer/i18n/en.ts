export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Crewup",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Crewup has been downloaded, would you like to install it and relaunch?",
