export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Crewup",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Crewup er lastet ned. Vil du installere den og starte på nytt?",
