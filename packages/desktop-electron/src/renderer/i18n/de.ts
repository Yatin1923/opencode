export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Crewup",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Crewup wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
