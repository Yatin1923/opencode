export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Crewup-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Crewup-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
